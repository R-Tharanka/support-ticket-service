...
public class support_ticket_utill {
    ...
    ////////////////////// /////////////////////////////////////////
    public static boolean insertSupportTicket(String fName, String lName, String email, String date, String subject,
            String issue) {
        ...
        try {
            ...
            String sql = "INSERT INTO support_ticket (first_name, last_name, email, date, subject, issue) VALUES ('"
                    + fName + "', '" + lName + "', '" + email + "', '" + date + "','" + subject + "', '" + issue + "')";
    ...
    public static boolean updateSupportTicket(int id, String f_name, String l_name, String email, String date,
            String subject, String issue) {
        ...
        try {
            ...
            String sql = "UPDATE support_ticket SET first_name = '" + f_name + "', last_name = '" + l_name
                    + "', email= '" + email + "', date = '" + date + "', subject = '" + subject + "', issue = '" + issue
                    + "' WHERE id = '" + id + "' ";

            System.out.println("DAO - updateSupportTicket" + "ID: " + id + ", First Name: " + f_name + ", Last Name: "
                    + l_name + ", Email: " + email + ", Date: " + date + ", subject = '" + subject + "', Issue: "
                    + issue);
