    ...
    <div class="container">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-container">
                                    <a href="view_update_TicketServlet?id=${ticket.id}" class="btn btn-primary" style="padding: 0.4rem 0.8rem">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button onclick="show_delete_confirm('${ticket.id}')" class="btn btn-danger" style="padding: 0.4rem 0.8rem">
        ...
        <div id="delete_confirm_div" class="confirmation-dialog">
            ...
            <div id="con_btns" class="btn-container">
                ...
                <button onclick="hide_delete_confirm()" class="btn btn-outline"><i class="fas fa-times"></i> Cancel</button>
            </div>
        </div>
    </div>
